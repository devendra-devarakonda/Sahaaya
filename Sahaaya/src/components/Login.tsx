...
export function Login({ setCurrentPage, setIsAuthenticated, setUserProfile, justLoggedInRef }: LoginProps) {
  ...
  const handleEmailLogin = async (e: React.FormEvent) => {
    ...
    try {
      // Set the flag BEFORE calling signInWithPassword
      ...
      // Don't manually set state here - let the auth listener handle it
      // The justLoggedInRef flag will tell the listener to redirect to dashboard
    } catch (error: any) {
      // Reset the flag if login failed
