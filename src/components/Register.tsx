    ...
    try {
      ...
      if (data.user) {
        ...
        if (!data.session) {
          ...
          // Email auto-confirmed (if enabled in Supabase settings)
          setUserProfile({
            id: data.user.id,
        ...
        <div className="w-full max-w-md space-y-6">
          ...
          <div className="text-center space-y-4">
            <div className="flex justify-center">
              <div className="w-16 h-16 rounded-2xl flex items-center justify-center shadow-lg animate-in zoom-in duration-300" style={{ backgroundColor: '#41695e' }}>
          ...
          <Card className="shadow-lg border-0">
            <CardContent className="p-6 space-y-4">
              <div className="text-center space-y-3">
                <CheckCircle className="h-12 w-12 mx-auto" style={{ color: '#41695e' }} />
                <h3 className="text-lg" style={{ color: '#033b4a' }}>Almost There!</h3>
                <p className="text-gray-600">
                  Click the confirmation link in your email to activate your Sahaaya account and start {selectedRole === 'individual' ? 'helping your community' : 'managing community assistance programs'}.
                </p>
              </div>

              <div className="p-4 rounded-lg" style={{ backgroundColor: '#e8f5f0' }}>
                <h4 className="text-sm font-medium mb-2" style={{ color: '#033b4a' }}>Next steps:</h4>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-gray-600">
                    If you don't receive the email within a few minutes, check your spam folder or call our support helpline at <span className="font-medium">1800-SAHAAYA</span> for assistance.
                  </p>
                </div>
              </div>
            </CardContent>
